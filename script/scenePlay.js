var scenePlay = new Phaser.Class({
  ...
  preload() {
    ...
    this.load.image("btnPlay", "assets/images/btn_play.png");
    ...
    this.load.audio("snd_klik_1", "assets/audio/klik1.mp3");
    this.load.audio("snd_klik_2", "assets/audio/klik2.mp3");
    this.load.audio("snd_klik_3", "assets/audio/klik3.mp3");
  },
  ...
  create() {
    ...
    //membuat scale karakter menjadi @ (tidak terlihat)
    ...
    //Inisialisasi variabel global this.score dengan nilai aval e
    this.score = 0;
    //membuat panel nilai
    ...
    this.gameover = function () {
      ...
      //pernah ada nilai yang tersimpan, akan mengmabil dari nilai
    ...
    this.input.on(
      ...
      function (pointer, currentlyover) {
        ...
        let index = Math.floor(Math.random() * this.snd_click.length);
        this.snd_click[index].play();
    ...
    for (let i = 0; i < 2; i++) {
      ...
      //menambah nilai bg x untuk perulangan selanjutnya
      bg_x += 1366;
    }
  },
  ...
  update() {
    if (this.isGameRunning) {
      ...
      if (this.timerHalangan == 0) {
        //mendapatkan angka acak antara 60 hingga 688
      ...
      //mengurangi tiner halangan sebanyak 1 setiap framenya
      //jika sudah, akan diatur ulang lagi nilainya pada kode di atas
      this.timerHalangan--;
